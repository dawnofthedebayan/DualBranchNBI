...
def set_model(opt,ckpt_path_model,ckpt_path_classifier):
...
def test(loader, model,classifier):
    """validation"""
    model.eval()
...
def main():
    ...
    model, classifier, criterion = set_model(opt,ckpt_path_model,ckpt_path_classifier)
    logits, labels = test(test_loader, model,classifier)
