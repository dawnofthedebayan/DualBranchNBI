...
def parse_option():
    ...
    opt.model_path = './save/CEMixedPatient/{}_models'.format(opt.dataset)
    opt.tb_path = './save/CEMixedPatient/{}_tensorboard'.format(opt.dataset)
    ...
    opt.model_name = 'CEMixedPatient_{}_{}_modelnumber_{}_aug_{}'.\
