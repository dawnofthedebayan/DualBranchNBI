...
from util import TwoCropTransform, AverageMeter, make_weights_for_balanced_classes
...
def parse_option():
    ...
    opt.model_path = './save/SupConLatentBalanced/{}_models'.format(opt.dataset)
    opt.tb_path = './save/SupConLatentBalanced/{}_tensorboard'.format(opt.dataset)
    ...
    opt.model_name = 'SupConLatentBalanced_{}_{}_modelnumber_{}_aug_{}_latent_{}'.\
...
def train(train_loader, model, model_scatter,classifier, criterion_supcon, criterion_ce, optimizer_model,optimizer_classifier, epoch, opt):
    ...
    for idx, (images, labels) in enumerate(train_loader):
        ...
        #print(features_scat.shape,features_all.shape)
